...
<div class="container">
    <h1>Add new extra class:</h1>

    <form action="${pageContext.request.contextPath}/addExtraClass" method="POST">
        <div class="form-group">
            <label for="extraClassName">Extra class name:</label>
            <input type="text" class="form-control" id="extraClassName" name="extraClassName">
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary">Add extra class</button>
    </form>
