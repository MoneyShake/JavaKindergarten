...
<div class="container">
    <h1>Add teacher to group:</h1>
    <form class="form-inline" action="${pageContext.request.contextPath}/addTeacherToGroup" method="POST">
    ...
    <h1>All teachers:</h1>
    <a class="btn btn-primary btn-block mb-3" href="${pageContext.request.contextPath}/addTeacher">Add new teacher</a>
        ...
        <c:forEach var="teacher" items="${teachers}">
            <tr>
                ...
                <td>
                    ...
                    <form action="${pageContext.request.contextPath}/teachers/info" method="GET" class="form-inline">
                        <button type="submit" class="btn btn-info">Info</button>
                        <input type="hidden" value="${teacher.getId()}" name="teacherId">
                    </form>
                </td>
                <td>
                    <form action="${pageContext.request.contextPath}/deleteTeacher" method="POST" class="form-inline">
