...
<div class="container">
    <h1>Teacher: <c:out value="${teacher.getFirstName()}"/> <c:out value="${teacher.getLastName()}"/> <c:out value="${teacher.getSex()}"/></h1>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col">Delete teacher form group</th>
        </tr>
        </thead>
        <tbody>
        ...
        <c:forEach var="group" items="${groups}">
            <tr>
                ...
                <td>
                    <form action="${pageContext.request.contextPath}/teachers/deleteFromGroup" method="POST" class="form-inline">
                        <button type="submit" class="btn btn-danger">Delete teacher from group</button>
